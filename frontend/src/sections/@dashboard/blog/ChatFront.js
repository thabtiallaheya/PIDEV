...
export default class ChatFront extends Component {
      ...
      render() {
        return (
          <div className="main" id='wrapper'>
            ...
            <div>
              <div className="title">
                <Text id="main-heading" type="secondary" style={{ fontSize: '36px' }}>Chat with Learningo team <ChatIcon color ="blue"/> let's start : {this.state.userName}</Text>
              </div>
            ...
            <div style={{ padding: '200px 40px' }}>
               <TitleStyle > <a>Welcome let's enter your name and join our team !</a> <ChatIcon color ="blue"/> </TitleStyle>
              <Search
