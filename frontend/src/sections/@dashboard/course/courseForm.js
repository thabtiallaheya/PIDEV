...
export function CourseForm() {
  ...
  const RegisterSchema = Yup.object().shape({
    ...
    pdf:Yup.mixed().nullable().required('image is required'),
    video:Yup.mixed().nullable().required('image is required')
  });
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values) => {
      ...
      axios
        .post('http://localhost:3001/api/course/insert', formdata, {
